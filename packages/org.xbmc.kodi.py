...
description = '''
<h3>NOTE: Only supports webOS 4.0 and newer! Does not work on certain 2019 models (K5Lp).</h3>
![Kodi Logo](https://raw.githubusercontent.com/xbmc/xbmc/master/docs/resources/banner.png)
<p align="center">
  <strong>
